...
], function (Theming, BaseController, JSONModel, ExceptionService) {
	"use strict";

	return BaseController.extend("djembe.in.my.pocket.controller.Exception", {

		///////////////////////////////////////////////////////////////////////
		//	ATTRIBUTES
		///////////////////////////////////////////////////////////////////////

		__targetName: "Exception",
		 ...
		 * @memberOf djembe.in.my.pocket.view.Exception
		 */
		onInit: function () {
		...
		__setBindingForView: function () {
			var aLogs = ExceptionService.getInstance().getLogEntries();
			console.log(aLogs);
		}
